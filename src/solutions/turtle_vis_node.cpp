...
int main( int argc, char** argv )
{
   ...
   ros::Subscriber sub=n.subscribe("turtle_control",100,
                                   &turtleSpace::TurtleClass::CALLBACK_FUNCTION/*//#>>>>TODO: DEFINE THE CALLBACK FUNCTION FROM THE METHOD OF THE CLASS*/,
    ...
    while(ros::ok())
    {
        ...
        turtlePose_local=turtleFunc.CLASS METHOD TO OBTAIN THE NEW TURTLE POSE();
